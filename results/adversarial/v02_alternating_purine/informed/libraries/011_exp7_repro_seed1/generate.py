"""011_exp7_repro_seed1 — exact replica of exp 007 with SEED=1.

Test reproducibility of exp 007's eval_06/11 = 0.228 K562 unlock. If seed=1
returns ~0.14, the exp 7 result was a lucky-seed artifact. If ~0.15, the
recipe is robust.
