"""
018_mix_10dhs_90uniform
=======================
5k dhs_specific + 45k pure uniform random. Push toward uniform extreme
to maximize eval_08 (0.124 at pure uniform). Just enough bio anchor.
"""
import gzip
import sys
...
def main():
    ...
    dhs_seqs = []
    pool = rng.choice(len(chroms), size=int(N_DHS * 1.6), replace=False, p=w)
    for i in pool:
