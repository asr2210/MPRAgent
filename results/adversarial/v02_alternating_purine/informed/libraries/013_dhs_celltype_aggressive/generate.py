"""013_dhs_celltype_aggressive — push cell-type DHS shares.

Exp 012 hit mean_r=0.162 with 20k cell-type-matched DHS. Push further:
- More component DHS (26k total vs 20k)
- Drop Table_S2 (see if S2 was contributing)
- Keep cCRE uniform as general grammar anchor

Composition (50k):
- 10k DHS Neural (SK-N-SH)
- 8k DHS Myeloid/erythroid (K562)
- 8k DHS Digestive (HepG2)
- 4k cCRE uniform
- 0k Table_S2 (DROPPED)
- 20k paired flanks
"""
