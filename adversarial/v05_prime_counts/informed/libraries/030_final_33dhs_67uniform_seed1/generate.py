"""
030_final_33dhs_67uniform_seed1
===============================
FINAL — same recipe as Exp 019 (best mean_r 0.0488) but seed=1.
Validates the winning recipe across random seeds.

16,667 dhs_specific (1/sqrt numsamples weighting) + 33,333 uniform random.
"""
import gzip
import sys
