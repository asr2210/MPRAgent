"""
Experiment 025 — orth-DHS + cCRE without dELS AND CA

CA (chromatin accessibility only — DNase signal alone) is the second-
largest cCRE class (246k). DHS half already covers DNase content;
CA may be redundant with the orth-DHS half.

Design:
  25 k orth-DHS (numsamples ≤ 5)
  25 k cCRE balanced across 6 classes (no dELS, no CA): 4166 each
    CA-CTCF, CA-H3K4me3, CA-TF, PLS, TF, pELS

Tests whether even more aggressive cCRE rebalance helps eval_01.
"""
...
def main():
    ...
    per_cls = N_CCRE // len(classes)  # 25000/6 = 4166
    parts = []
    for c in classes:
