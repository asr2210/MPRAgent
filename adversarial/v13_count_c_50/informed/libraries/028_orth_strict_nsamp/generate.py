...
Push the cell-type-specificity lever: orth pool filtered to
numsamples ≤ 2 (was ≤5 in 020+/025).

If 028 > 025: more aggressive cell-type-specificity helps.
If 028 < 025: ≤5 was already optimal.
"""
...
def main():
    ...
    print(f"orth-DHS nsamp<={MAX_NSAMP} pool: {len(pool):,}")
