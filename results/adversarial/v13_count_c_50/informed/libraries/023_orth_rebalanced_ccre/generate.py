"""
Experiment 023 — orth-DHS + cCRE without dELS, rebalanced classes

dELS is 63 % of cCRE pool (1.5M of 2.35M elements) and the "least
specific" class — distal enhancer with DNase+H3K27ac only. Class
balancing already over-represents rare classes, but dELS may still
be dragging cCRE half quality.

Design:
  25 k orth-DHS (numsamples ≤ 5)
  25 k cCRE balanced across 7 NON-dELS classes (3571 each).

If 023 > 020/021: dELS was diluting cCRE half.
If 023 < 020/021: dELS contributed something despite being "generic".
"""
...
def main():
    ...
    per_cls = N_CCRE // len(classes)  # 25000/7 = 3571
    parts = []
    for c in classes:
