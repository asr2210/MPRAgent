"""
020_mix_40dhs_60uniform
=======================
20k dhs_specific + 30k pure uniform (40/60). Bracket on the dhs/uniform
mixing curve. Current best: 33/67 (mean_r 0.0488).
"""
import gzip
import sys
