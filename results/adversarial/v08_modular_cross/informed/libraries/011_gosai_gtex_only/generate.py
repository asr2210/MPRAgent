"""
Experiment 011 — Gosai GTEX sub-source only, quality + stratified.

Parallel ablation to 010 (UKBB-only). GTEX is the larger sub-source (446K) of
eQTL variant-centric MPRA. Tests whether GTEX-derived sequences match the eval
distribution better than UKBB.
"""
import os, random
...
print(f"{len(records)} GTEX sequences after lfcSE<0.3")
