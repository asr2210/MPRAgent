"""
Experiment 024 — GTEX lfcSE<0.7 random with seed=123.

Reproducibility / variance estimate of the 019 breakthrough. If a different
seed gives a very different eval_01, the gains are noisy. If similar, the
GTEX-loose strategy is robust.
"""
import os, random
...
with open(OUT, "w") as f:
    for s in seqs:
        f.write(s + "\n")
print(f"wrote {len(seqs)} to {OUT} (seed=123)")
