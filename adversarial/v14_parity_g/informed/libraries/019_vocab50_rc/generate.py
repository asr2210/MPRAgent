#!/usr/bin/env python3
"""
019_vocab50_rc — 016 design (50-TF motif vocab) + RC. 25k motif-packed
parents + 25k reverse-complements. Tests RC augmentation on motif lib.
"""
import random
...
def main():
    ...
    with open(OUT, "w") as f:
        for s in out:
            f.write(s + "\n")
    print(f"Wrote {len(out)} motif+RC sequences -> {OUT}")
