#!/usr/bin/env python3
"""
028_gene_density_sq_500kb — complete the bin-size sweep.

Gene-density squared, 500kb bins (between 1Mb and 250kb).

Bin sweep so far (squared, 3-seed, full genome):
- 1Mb (E22):   0.5071
- 500kb (this): ?
- 250kb (E24): 0.5084 ← current peak
- 100kb (E25): 0.5063

If 500kb > 0.5084: monotonic up to 500kb (unlikely).
If 0.508 ≤ 500kb < 0.5084: 250kb confirmed as sweet spot.
If 500kb ≈ 0.5071: 1Mb-like, 250kb is a special minimum.
"""
import gzip
