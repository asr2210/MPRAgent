"""
Experiment 017 — GTEX-only random + quality (no stratification).

Parallel to exp 014 (which used full Gosai mix). Tests if GTEX-only natural
distribution matches eval better than the natural Gosai mix.
- exp 014 (full Gosai random quality): eval_01 = 0.0168, mean across 14 = 0.0128
- exp 011 (GTEX-only stratified):       eval_01 = 0.0148, mean across 14 = 0.0133
"""
import os, random
...
print(f"{len(seqs_pool)} GTEX sequences after lfcSE<0.5")
