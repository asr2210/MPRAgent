"""
Experiment 019 — GTEX with looser quality (lfcSE<0.7) random.

Tests whether more sequence diversity (larger pool) at the cost of noisier
labels improves over the lfcSE<0.5 breakthrough.
"""
import os, random
...
print(f"{len(seqs_pool)} GTEX sequences after lfcSE<0.7")
