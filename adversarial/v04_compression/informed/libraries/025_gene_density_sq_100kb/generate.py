#!/usr/bin/env python3
"""
025_gene_density_sq_100kb — E22-style squared weighting, 100kb bins.

Bin-size sweep so far:
- 1Mb (E22): 0.5071
- 250kb (E24): 0.5084
- 100kb (this): ?

If 100kb > 250kb: continue shrinking (50kb next).
If saturated: pick 250kb as the optimum and combine with other axes.
If worse: 250kb is the sweet spot.
"""
import gzip
