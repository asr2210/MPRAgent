"""
Experiment 021: Even denser packing — 15 motifs/seq with overlap allowed.

Push exp 020's design further. 15 attempted inserts means with ~50% overlap
rate, ~7-8 motifs survive intact and the sequence is ~80% motif-derived.

If exp 021 > 0.435: density is a real lever, push further.
If exp 021 ≈ 0.428: density saturated around 8 (exp 020).
If exp 021 < 0.42: too much density / fidelity loss hurts.
"""
